...
import { RestaurantSwitcher, type Restaurant } from '@/components/layout/restaurant-switcher';
...
export default function DashboardLayout({
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      if (profile) {
        setUserName(profile.full_name || 'User1');
        setUserEmail(profile.email || 'usercc@example.com');
        setUserRole(profile.role || 'users');
      }
    };
    fetchUserData();
  }, []); // Re-fetch user data if the path changes
