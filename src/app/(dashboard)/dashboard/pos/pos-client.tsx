  ...
  return (
    <div className="flex h-full flex-col p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        {/* <span className="text-sm text-gray-500">Restaurant ID: {restaurantId}</span> */}
      </div>
            ...
            {selectedTableId ? (
              <div className="flex-grow">
                ...
                {menuItems.length === 0 ? (
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 overflow-y-auto max-h-[50vh]"> {/* Added max-h and overflow */}
                    {menuItems.map(item => (
                ...
                {/* TODO: Order actions (Add to Order, Send, Pay) */}
